...
public class VentanaRedimensionarDatafile extends JFrame {
    ...
    public VentanaRedimensionarDatafile() {
        setTitle("📏 Redimensionar Datafile - Oracle XE");
        ...
        // === ENCABEZADO ===
        JLabel lblTitulo = new JLabel("Redimensionar Datafile (Ruta Completa)", JLabel.CENTER);
        ...
        // === Campo Ruta Datafile ===
        JLabel lblRuta = crearLabel("Ruta Datafile (abs):");
        card.add(lblRuta, gbc);
        gbc.gridx = 1;
        txtFile = crearCampoTexto();
        card.add(txtFile, gbc);

        // === Campo Tamaño ===
        gbc.gridx = 0;
        gbc.gridy++;
        JLabel lblSize = crearLabel("Nuevo Tamaño (MB):");
    ...
    private void redimensionar() {
        ...
        if (ruta.isEmpty() || sizeStr.isEmpty()) {
            JOptionPane.showMessageDialog(this, "⚠️ Complete todos los campos.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (ok) {
            JOptionPane.showMessageDialog(this, "✅ Datafile redimensionado correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "❌ Error al redimensionar. Revise la consola.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(VentanaRedimensionarDatafile::new);
    }
}
