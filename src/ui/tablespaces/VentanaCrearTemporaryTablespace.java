...
public class VentanaCrearTemporaryTablespace extends JFrame {
    ...
    public VentanaCrearTemporaryTablespace() {
        ...
        // === ENCABEZADO ===
        JLabel lblTitulo = new JLabel("Crear un nuevo Temporary Tablespace", JLabel.CENTER);
        ...
        // === Campo Nombre ===
        JLabel lblNombre = crearLabel("Nombre del TEMP Tablespace:");
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        JLabel lblRuta = crearLabel("Ruta TEMPFILE (absoluta):");
    ...
    // === MÉTODOS DE LÓGICA ===
    private void crearTemporaryTablespace() {
        ...
        boolean ok = ts.crearTemporaryTablespace(nombre.toUpperCase(), ruta, size);
        if (ok) {
            JOptionPane.showMessageDialog(this, "✅ Temporary Tablespace creado correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "❌ Error al crear el TEMP Tablespace. Verifique la consola.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(VentanaCrearTemporaryTablespace::new);
    }
}
