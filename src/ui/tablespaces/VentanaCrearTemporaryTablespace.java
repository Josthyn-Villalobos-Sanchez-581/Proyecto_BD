...
public class VentanaCrearTemporaryTablespace extends JFrame {
    ...
    public VentanaCrearTemporaryTablespace() {
        setTitle("Crear Temporary Tablespace");
        setSize(480, 300);
        ...
        JLabel lbl = new JLabel("Crear nuevo Temporary Tablespace", JLabel.CENTER);
        ...
        panel.add(new JLabel("Nombre TEMP TS:", JLabel.RIGHT));
        txtNombre = new JTextField();
        panel.add(txtNombre);

        panel.add(new JLabel("Ruta TEMPFILE (abs):", JLabel.RIGHT));
        ...
        btnCrear.addActionListener(e -> {
            ...
            if (ok) {
                ...
                JOptionPane.showMessageDialog(this,"Error al crear TEMP TS. Ver consola.","Error",JOptionPane.ERROR_MESSAGE);
            }
        });
