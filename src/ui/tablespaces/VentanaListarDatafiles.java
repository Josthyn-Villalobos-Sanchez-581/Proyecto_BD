...
public class VentanaListarDatafiles extends JFrame {
    ...
    public VentanaListarDatafiles() {
        ...
        // === ENCABEZADO ===
        JLabel lblTitulo = new JLabel("Listado de Datafiles (DBA_DATA_FILES)", JLabel.CENTER);
    ...
    // === LÓGICA PRINCIPAL ===
    private void cargarDatafiles() {
        List<String> lista = ts.listarDataFiles();
        if (lista == null || lista.isEmpty()) {
            area.setText("⚠️ No se encontraron datafiles o ocurrió un error.\n\nPor favor, revise la consola para más detalles.");
        } else {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(VentanaListarDatafiles::new);
    }
}
